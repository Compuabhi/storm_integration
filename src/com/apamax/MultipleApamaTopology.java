...
public class MultipleApamaTopology {
...
//		builder.setSpout("Temp_Spout", new basicSpout(), 2);
		builder.setBolt("Apama_Bolt###1", new ApamaTerminalBolt("localhost",15904,config2), 2).fieldsGrouping("Temp_Spout",new Fields("sentence"));
		builder.setBolt("Basic_Bolt", new SplitBolt(), 2).shuffleGrouping("Temp_Spout");
		builder.setBolt("Apama_Bolt###2", new ApamaTerminalBolt("localhost",15903,config), 3).fieldsGrouping("Basic_Bolt",new Fields("word"));
